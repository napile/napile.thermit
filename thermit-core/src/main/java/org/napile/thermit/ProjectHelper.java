...
{
	/**
	 * The URI for thermit name space
	 */
	public static final String ANT_CORE_URI = "antlib:org.napile.thermit";

	/**
	 * The URI for antlib current definitions
	 */
	public static final String ANT_CURRENT_URI = "thermit:current";
	 ...
	 */
	public static final String ANT_TYPE = "thermit-type";
	 ...
	 * @see org.napile.thermit.ProjectHelperRepository#getHelpers()
	 */
	 ...
	 *                Must not be <code>null</code>.
	 * @throws BuildException if any of the attributes can't be handled by
	 *                        the target
	 * @deprecated since 1.6.x.
	 ...
	 * For BC purposes the names from the thermit core uri will be
	 ...
	 *
	 * @param buildFile the file expected to be parsed (never <code>null</code>)
