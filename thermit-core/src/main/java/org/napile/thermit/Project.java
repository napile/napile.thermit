...
import org.napile.thermit.input.DefaultInputHandler;
import org.napile.thermit.input.InputHandler;
import org.napile.thermit.helper.DefaultExecutor;
import org.napile.thermit.types.FilterSet;
import org.napile.thermit.types.FilterSetCollection;
import org.napile.thermit.types.Description;
import org.napile.thermit.types.Path;
import org.napile.thermit.types.Resource;
import org.napile.thermit.types.ResourceFactory;
...
import org.napile.thermit.util.VectorSet;
...
public class Project implements ResourceFactory
{
	 ...
	 *
	 * @throws BuildException if an vital property could not be set.
	 * @since Ant 1.7
	 */
	...
	/**
	 * Set a property to the location of thermit.jar.
	...
	{
		File antlib = org.napile.thermit.launch.Locator.getClassSource(Project.class);
		if(antlib != null)
		{
	 ...
	 * property <code>thermit.project.name</code>.
	 *
	 ...
	 *                Must not be <code>null</code>.
	 * @throws BuildException if the specified file doesn't exist or
	 *                        isn't a directory.
	 */
	 ...
	 * methods are used in conjunction with the <code>thermit.executor.class</code>
	 ...
	 * @see org.napile.thermit.util.JavaEnvUtils#getJavaVersion
	 * @deprecated since 1.5.x.
	 *             Use org.napile.thermit.util.JavaEnvUtils instead.
	 */
	...
	/**
	 * Set the <code>thermit.java.version</code> property and tests for
	 ...
	 * @throws BuildException if the task name is recognised but task
	 *                        creation fails.
	 */
	 ...
	 * @throws BuildException if the data type name is recognised but
	 ...
	 * @throws BuildException if the last modified time cannot be set
	 ...
	 *                    dependency order.
	 *                    Must not be <code>null</code>.
	 * @throws BuildException if a non-existent target is specified or if
