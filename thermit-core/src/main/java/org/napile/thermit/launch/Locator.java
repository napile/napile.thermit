 ...
 * {@link <a href="http://issues.napile.org/bugzilla/show_bug.cgi?id=42275">running thermit off a network share can cause Ant to fail</a>}
 * {@link <a href="http://issues.napile.org/bugzilla/show_bug.cgi?id=8031">use File.toURI().toURL().toExternalForm()</a>}
 * {@link <a href="http://issues.napile.org/bugzilla/show_bug.cgi?id=42222">Locator implementation not encoding URI strings properly: spaces in paths</a>}
...
public final class Locator
{
	...
	// stolen from org.napile.xerces.impl.XMLEntityManager#getUserDir()
	 ...
	 * @throws MalformedURLException if the URLs for the jars cannot be
	 *                               formed.
	 */
	 ...
	 * @throws MalformedURLException if the URLs for the files cannot be
	 *                               formed.
	 */
