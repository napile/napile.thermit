 ...
 *
 */
package org.napile.thermit.launch;
...
public class Launcher
{
	 ...
	 * {@value}
	 */
	public static final String ANTHOME_PROPERTY = "thermit.home";

	/**
	 * The Ant Library Directory property.
	 * {@value}
	 */
	public static final String ANTLIBDIR_PROPERTY = "thermit.library.dir";

	/**
	 * The directory name of the per-user thermit directory.
	 * {@value}
	 */
	public static final String ANT_PRIVATEDIR = ".thermit";
	 ...
	 * in between. For example, on Unix, it's <code>.thermit/lib</code>.
	 */
	 ...
	 * {@value}
	 */
	public static final String MAIN_CLASS = "org.napile.thermit.Main";
	 ...
	 * @return an exit code. As the normal thermit main calls exit when it ends,
	...
	private int run(String[] args) throws LaunchException, MalformedURLException
	{
		...
		if(!antHome.exists())
		{
			throw new LaunchException("Ant home is set incorrectly or " + "thermit could not be located (estimated value=" + antHome.getAbsolutePath() + ")");
		}
	 ...
	 * determine thermit library directory for system jars: use property
	 * or default using location of thermit-launcher.jar
	 *
	 * @param antLauncherDir the dir that thermit-launcher ran from
	 * @return the URLs
	 * @throws MalformedURLException if the URLs cannot be created.
	 */
	...
	/**
	 * Get the jar files in user.home/.thermit/lib
	 *
	 ...
	 * @param userJars   the jars in ~/.thermit/lib
