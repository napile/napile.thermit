 ...
 * property <code>org.napile.thermit.ArgumentProcessor</code>, or via a JDK1.3
 * 'service', by putting the fully qualified name of the implementation into the
 * file <code>META-INF/services/org.napile.thermit.ArgumentProcessor</code>
 * <p/>
 * Use the system property <code>thermit.argument-processor.debug</code> to enable
...
public class ArgumentProcessorRegistry
{
	...
	private static final String DEBUG_ARGUMENT_PROCESSOR_REPOSITORY = "thermit.argument-processor-repo.debug";
	...
	private static final String SERVICE_ID = "META-INF/services/org.napile.thermit.ArgumentProcessor";
	...
	private ArgumentProcessor getProcessor(String helperClassName)
	{
		try
		{
			@SuppressWarnings("unchecked") Class<? extends ArgumentProcessor> cl = (Class<? extends ArgumentProcessor>) Class.forName(helperClassName);
