...
package org.napile.thermit.input;
 ...
 * system property thermit.input.properties, the prompt is the key for input.
 *
 * @since Ant 1.5
 */
public class PropertyFileInputHandler implements InputHandler
{
	 ...
	 */
	public static final String FILE_NAME_KEY = "thermit.input.properties";
	...
	private synchronized void readProps() throws BuildException
	{
		if(props == null)
		{
			...
			if(propsFile == null)
			{
				throw new BuildException("System property " + FILE_NAME_KEY + " for PropertyFileInputHandler not" + " set");
			}
