...
import org.napile.thermit.taskdefs.Redirector;
...
public class RedirectorElement extends DataType
{
	...
	protected Mapper createMergeMapper(File destfile)
	{
		...
		result.setClassname(org.napile.thermit.util.MergingMapper.class.getName());
	...
	protected void dieOnCircularReference(Stack<Object> stk, Project p) throws BuildException
	{
		...
		else
		{
			...
			final List<? extends List<FilterChain>> filterChainLists = Arrays.<List<FilterChain>>asList(inputFilterChains, outputFilterChains, errorFilterChains);
