...
import org.napile.thermit.types.selectors.AbstractSelectorContainer;
...
public class Files extends AbstractSelectorContainer implements ResourceCollection
{
	...
	private static final Iterator<Resource> EMPTY_ITERATOR = Collections.<Resource>emptySet().iterator();
