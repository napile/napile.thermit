...
public class MappedResource extends ResourceDecorator
{
	...
	{
		return FileProvider.class.isAssignableFrom(clazz) ? null : getResource().as(clazz);
	}
	...
	public boolean equals(Object other)
	{
		...
		return (myName == null ? otherName == null : myName.equals(otherName)) && getResource().equals(m.getResource());
	}
}
