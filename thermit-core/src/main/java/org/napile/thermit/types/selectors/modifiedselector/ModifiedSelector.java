...
package org.napile.thermit.types.selectors.modifiedselector;
...
import org.napile.thermit.BuildListener;
import org.napile.thermit.BuildEvent;
import org.napile.thermit.types.EnumeratedAttribute;
import org.napile.thermit.types.Parameter;
...
import org.napile.thermit.types.selectors.BaseExtendSelector;
 ...
 *   &lt;copy todir="dest"&gt;
 *       &lt;filelist dir="src"&gt;
 *           &lt;custom class="org.napile.thermit.type.selectors.ModifiedSelector"&gt;
 ...
 * for homepage generation (e.g. with <a href="http://forrest.napile.org/">
 ...
 * (using org.napile.thermit.IntrospectionHelper) therefore no special
...
public class ModifiedSelector extends BaseExtendSelector implements BuildListener, ResourceSelector
{
	...
	public void configure()
	{
		...
		else
		{
			...
			{
				// use Algorithm specified by classname
				@SuppressWarnings("unchecked") Comparator<? super String> localComparator = loadClass(comparatorClass, "is not a Comparator.", Comparator.class);
	...
	/**
	 * Defined in org.napile.thermit.types.Parameterizable.
	...
	protected void tryToSetAParameter(Object obj, String name, String value)
	{
		...
		catch(org.napile.thermit.BuildException e)
		{
			// no-op
		}
	}
