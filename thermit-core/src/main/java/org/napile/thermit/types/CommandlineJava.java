...
public class CommandlineJava implements Cloneable
{
	 ...
	 * specified, the build.sysclasspath and thermit.build.clonevm magic
	 ...
	 * thermit.build.clonevm has been set.
	 *
	...
	{
		return cloneVm || "true".equals(System.getProperty("thermit.build.clonevm"));
	}
}
