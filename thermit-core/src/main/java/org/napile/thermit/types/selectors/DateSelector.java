...
public class DateSelector extends BaseExtendSelector
{
	...
	public void verifySettings()
	{
		...
		else if(millis < 0 && dateTime != null)
		{
			...
			{
				setError("Date of " + dateTime + " Cannot be parsed correctly. It should be in" + ((pattern == null) ? " MM/DD/YYYY HH:MM AM_PM" : pattern) + " format.");
			}
		}
	}
	...
	public boolean isSelected(File basedir, String filename, File file)
	{
		...
		return (file.isDirectory() && !includeDirs) || when.evaluate(file.lastModified(), millis, granularity);
	}
