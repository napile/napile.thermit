...
public class FilterSet extends DataType implements Cloneable
{
	...
	{
		super();
		@SuppressWarnings("unchecked") Vector<Filter> clone = (Vector<Filter>) filterset.getFilters().clone();
		this.filters = clone;
	}
	...
	public synchronized Object clone() throws BuildException
	{
		...
		try
		{
			...
			@SuppressWarnings("unchecked") Vector<Filter> clonedFilters = (Vector<Filter>) getFilters().clone();
