 ...
 *
 * @see org.napile.thermit.types.resources.Touchable
 * @since Ant 1.5.2
 */
public class Resource extends DataType implements Comparable<Resource>, ResourceCollection
{
	...
	public long getSize()
	{
		...
		return isExists() ? (size != null ? size.longValue() : UNKNOWN_SIZE) : 0L;
	}
	...
	{
		return isReference() ? ((Resource) getCheckedRef()).iterator() : new Iterator<Resource>()
		{
