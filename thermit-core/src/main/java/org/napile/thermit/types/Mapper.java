...
import org.napile.thermit.util.CompositeMapper;
import org.napile.thermit.util.ContainerMapper;
...
public class Mapper extends DataType implements Cloneable
{
	...
	protected Class<? extends FileNameMapper> getImplementationClass() throws ClassNotFoundException
	{
		...
		ClassLoader loader = (classpath == null) ? getClass().getClassLoader()
	...
	public static class MapperType extends EnumeratedAttribute
	{
		...
		public MapperType()
		{
			...
			implementations.put("identity", "org.napile.thermit.util.IdentityMapper");
			implementations.put("flatten", "org.napile.thermit.util.FlatFileNameMapper");
			implementations.put("glob", "org.napile.thermit.util.GlobPatternMapper");
			implementations.put("merge", "org.napile.thermit.util.MergingMapper");
			implementations.put("regexp", "org.napile.thermit.util.RegexpPatternMapper");
			implementations.put("package", "org.napile.thermit.util.PackageNameMapper");
			implementations.put("unpackage", "org.napile.thermit.util.UnPackageNameMapper");
		}
