...
import org.napile.thermit.util.bzip2.CBZip2InputStream;
...
{
	private static final char[] MAGIC = new char[]{
			'B',
			'Z'
	};
	 ...
	 */
	public BZip2Resource(org.napile.thermit.types.ResourceCollection other)
	{
		super(other);
	}
