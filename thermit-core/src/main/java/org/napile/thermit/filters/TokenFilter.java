...
import org.napile.thermit.util.Tokenizer;
import org.napile.thermit.util.LineTokenizer;
 ...
 * @see ChainableReader
 * @see org.napile.thermit.DynamicConfigurator
 * @since Ant 1.6
 */
public class TokenFilter extends BaseFilterReader implements ChainableReader
{
	 ...
	 */
	public static class FileTokenizer extends org.napile.thermit.util.FileTokenizer
	{
	}
	 ...
	 */
	public static class StringTokenizer extends org.napile.thermit.util.StringTokenizer
	{
	}
	...
	public static class ReplaceRegex extends ChainableReaderFilter
	{
		...
		public String filter(String line)
		{
			...
			return regexp.substitute(line, substitution.getExpression(getProject()), options);
		}
	}
	...
	public static class ContainsRegex extends ChainableReaderFilter
	{
		...
		public String filter(String string)
		{
			...
			return regexp.substitute(string, substitution.getExpression(getProject()), options);
		}
	}
