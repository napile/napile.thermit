 ...
 * <p/>
 * <pre>
 * &lt;filterreader classname=&quot;org.napile.thermit.filters.FixCrLfFilter&quot;&gt;
...
public final class FixCrLfFilter extends BaseParamFilterReader implements ChainableReader
{
	 ...
	 *
	 * @param rdr A Reader object providing the underlying stream. Must not be
	 *            <code>null</code>.
	 ...
	 * attribute.
	 *
	 * @param javafiles set to true to prevent this filter from changing tabs found in
	 *                  Java literals.
	 */
	 ...
	 *
	 * @param tabLength specify the length of tab in spaces. Valid values are between
	 *                  2 and 80 inclusive. The default for this parameter is 8.
	 * @throws IOException on error.
	 */
	public void setTablength(int tabLength) throws IOException
	{
		if(tabLength < MIN_TAB_LENGTH || tabLength > MAX_TAB_LENGTH)
		{
			throw new IOException("tablength must be between " + MIN_TAB_LENGTH + " and " + MAX_TAB_LENGTH);
		}
