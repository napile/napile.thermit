 ...
 *       &lt;fileset dir=&quot;input&quot; includes=&quot;*.txt&quot;/&gt;
 *       &lt;filterchain&gt;
 *           &lt;filterreader classname=&quot;org.napile.thermit.filters.SortFilter&quot;&gt;
 *             &lt;param name=&quot;comparator&quot; value=&quot;org.napile.thermit.filters.EvenFirstCmp&quot;/&gt;
 *           &lt;/filterreader&gt;
 *       &lt;/filterchain&gt;
 *   &lt;/copy&gt;
 * </pre>
 ...
 *                 classname="org.napile.thermit.filters.EvenFirstCmp&quot;/&gt;
 *   &lt;copy todir=&quot;build&quot;&gt;
 *       &lt;fileset dir=&quot;input&quot; includes=&quot;*.txt&quot;/&gt;
 *       &lt;filterchain&gt;
 *           &lt;sortfilter&gt;
...
public final class SortFilter extends BaseParamFilterReader implements ChainableReader
{
	 ...
	 *
	 * @param reverse Boolean representing reverse ordering process.
	 */
	...
	private void initialize() throws IOException
	{
		...
		if(params != null)
		{
			for(int i = 0; i < params.length; i++)
			{
				...
				{
					setReverse(Boolean.valueOf(params[i].getValue()).booleanValue());
					continue;
				}
