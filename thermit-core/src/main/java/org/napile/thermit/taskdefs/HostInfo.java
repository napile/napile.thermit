...
public class HostInfo extends Task
{
	 ...
	 *
	 * @param aPrefix the prefix to use.
	 * @since Ant 1.8
	 */
	 ...
	 *
	 * @param aHost the name or the address of the host, data for the local host
	...
	private void executeRemote()
	{
		...
		{
			log("Error retrieving remote host information for host:" + host + ".", e, Project.MSG_WARN);
			setDomainAndName(host);
			setProperty(ADDR4, DEF_REM_ADDR4);
			setProperty(ADDR6, DEF_REM_ADDR6);
		}
