...
import org.napile.thermit.input.GreedyInputHandler;
import org.napile.thermit.input.InputHandler;
import org.napile.thermit.input.InputRequest;
import org.napile.thermit.input.MultipleChoiceInputRequest;
import org.napile.thermit.input.PropertyFileInputHandler;
import org.napile.thermit.input.SecureInputHandler;
...
public class Input extends Task
{
	...
	public class Handler extends DefBase
	{
		...
		private InputHandler getInputHandler()
		{
			...
			if(classname != null)
			{
				return (InputHandler) (ClasspathUtils.newInstance(classname, createLoader(), InputHandler.class));
			}
	...
	/**
	 * Actual method executed by thermit.
	 *
