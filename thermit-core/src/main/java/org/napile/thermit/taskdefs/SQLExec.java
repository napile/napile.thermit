...
public class SQLExec extends JDBCTask
{
	...
	public int lastDelimiterPosition(StringBuffer buf, String currentLine)
	{
		...
		{
			if((delimiterType.equals(DelimiterType.NORMAL) && StringUtils.endsWith(buf, delimiter)) || (delimiterType.equals(DelimiterType.ROW) && currentLine.equals(delimiter)))
			{
	...
	private void printWarnings(SQLWarning warning, boolean force) throws SQLException
	{
		...
		if(showWarnings || force)
		{
			while(warning != null)
			{
				log(warning + " sql warning", showWarnings ? Project.MSG_WARN : Project.MSG_VERBOSE);
