...
public class JavaCC extends Task
{
	...
	protected static final String[] ARCHIVE_LOCATIONS = new String[]{
			"JavaCC.zip",
			"bin/lib/JavaCC.zip",
			"bin/lib/javacc.jar",
			"javacc.jar",
	...
	protected static final int[] ARCHIVE_LOCATIONS_VS_MAJOR_VERSION = new int[]{
			1,
			2,
			3,
			3,
	...
	{
		optionalAttrs.put(OPTIMIZE_TOKEN_MANAGER, optimizeTokenManager ? Boolean.TRUE : Boolean.FALSE);
	}
	...
	public void execute() throws BuildException
	{
		...
		cmdl.setClassname(JavaCC.getMainClass(classpath, JavaCC.TASKDEF_TYPE_JAVACC));
