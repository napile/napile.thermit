...
import org.napile.thermit.types.Comparison;
...
import org.napile.thermit.util.PropertyOutputStream;
...
public class Length extends Task implements Condition
{
	 ...
	 * @see org.napile.thermit.types.Comparison
	 */
	...
	{
		validate();
		PrintStream ps = new PrintStream((property != null) ? (OutputStream) new PropertyOutputStream(getProject(), property) : (OutputStream) new LogOutputStream(this, Project.MSG_INFO));
