...
public class AntVersion extends Task implements Condition
{
	...
	private DeweyDecimal getVersion()
	{
		...
		p.init();
		char[] versionString = p.getProperty("thermit.version").toCharArray();
	...
	/**
	 * Get the name of the property to hold the thermit version.
	 *
	...
	/**
	 * Set the name of the property to hold the thermit version.
	 *
