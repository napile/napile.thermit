...
import org.napile.thermit.taskdefs.optional.javah.JavahAdapter;
import org.napile.thermit.taskdefs.optional.javah.JavahAdapterFactory;
...
public class Javah extends Task
{
	...
	{
		log("Compilation " + cmd.describeArguments(), Project.MSG_VERBOSE);
