...
import static org.napile.thermit.MagicNames.ANT_SHELL_LAUNCHER_REF_ID;
import static org.napile.thermit.MagicNames.ANT_VM_LAUNCHER_REF_ID;
...
public class CommandLauncher
{
	...
	{
		CommandLauncher launcher = extractLauncher(ANT_SHELL_LAUNCHER_REF_ID, project);
		if(launcher == null)
		{
	...
	{
		CommandLauncher launcher = extractLauncher(ANT_VM_LAUNCHER_REF_ID, project);
		if(launcher == null)
		{
			launcher = vmLauncher;
		}
