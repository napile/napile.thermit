...
import org.napile.thermit.util.LineOrientedOutputStream;

/**
 * Logs each line written to this stream to the log system of thermit.
 * <p/>
...
public class LogOutputStream extends LineOrientedOutputStream
{
	...
	/**
	 * Logs a line to the log system of thermit.
	 *
