...
import org.napile.thermit.types.DTDLocation;
...
import org.napile.thermit.util.XmlConstants;
...
public class XMLValidateTask extends Task
{
	...
	protected XMLReader createXmlReader()
	{
		...
		if(reader instanceof XMLReader)
		{
			...
			log("Using SAX2 reader " + reader.getClass().getName(), Project.MSG_VERBOSE);
		}
		else
		{
			...
			if(reader instanceof Parser)
			{
				...
				log("Using SAX1 parser " + reader.getClass().getName(), Project.MSG_VERBOSE);
			}
			else
			{
	...
	/**
	 * A Parser property.
	 * See <a href="http://xml.napile.org/xerces-j/properties.html">
