 ...
 * <p>
 * Extends the
 * MatchingTask class provided in the default thermit distribution to provide a
...
public class EjbJar extends MatchingTask
{
	 ...
	 */
	public static class DTDLocation extends org.napile.thermit.types.DTDLocation
	{
	}
	...
	private void validateConfig() throws BuildException
	{
		...
		else if(config.namingScheme.getValue().equals(NamingScheme.BASEJARNAME) && config.baseJarName == null)
		{
	 ...
	 *
	 * @throws BuildException thrown whenever a problem is
	 *                        encountered that cannot be recovered from, to signal to thermit
