...
public class Touch extends Task
{
	...
	public static final DateFormatFactory DEFAULT_DF_FACTORY = new DateFormatFactory()
	{
		...
		{
			return DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.MEDIUM, Locale.US);
		}
	};
	...
	protected synchronized void checkConfiguration() throws BuildException
	{
		...
		if(dateTime != null && !dateTimeConfigured)
		{
			...
			log("Setting millis to " + workmillis + " from datetime attribute", ((millis < 0) ? Project.MSG_DEBUG : Project.MSG_VERBOSE));
