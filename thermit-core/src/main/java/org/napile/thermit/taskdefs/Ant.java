...
import org.napile.thermit.Main;
 ...
 *    &lt;thermit antfile=&quot;build.xml&quot; target=&quot;bar&quot; &gt;
...
public class Ant extends Task
{
	...
	public void execute() throws BuildException
	{
		...
		try
		{
			...
			if(newProject.getProperty(MagicNames.ANT_FILE).equals(getProject().getProperty(MagicNames.ANT_FILE)) && getOwningTarget() != null)
			{
				...
				for(Iterator<String> it = locals.iterator(); !circular && it.hasNext(); )
				{
					Target other = getProject().getTargets().get(it.next());
	...
	{
		@SuppressWarnings("unchecked") Hashtable<String, Object> thisReferences = (Hashtable<String, Object>) getProject().getReferences().clone();
	 ...
	 * well as properties named basedir or thermit.file.
	 *
	...
	private void addAlmostAll(Hashtable<?, ?> props, PropertyType type)
	{
		...
		while(e.hasMoreElements())
		{
			...
			{
				// basedir and thermit.file get special treatment in execute()
				continue;
			}
	 ...
	 * element of &lt;thermit&gt; and &lt;antcall&gt;.
	 */
	public static class Reference extends org.napile.thermit.types.Reference
	{
