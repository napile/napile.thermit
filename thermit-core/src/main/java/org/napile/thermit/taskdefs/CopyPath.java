...
public class CopyPath extends Task
{
	...
	{
		log("This task should have never been released and was" + " obsoleted by ResourceCollection support in <copy> available" + " since Ant 1.7.0.  Don't use it.", Project.MSG_ERR);
		...
		for(int sources = 0; sources < sourceFiles.length; sources++)
		{
			...
			for(int i = 0; i < toFiles.length; i++)
			{
				...
				try
				{
					...
					FILE_UTILS.copyFile(sourceFile, destFile, null, null, false, preserveLastModified, null, null, getProject());
				}
