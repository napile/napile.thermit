 ...
 *
 */
package org.napile.thermit.taskdefs.optional.depend.constantpool;
...
public abstract class ConstantPoolEntry
{
	 ...
	 * @throws IOException if the constant pool entry cannot be read
	 *                     from the stream
	 */
	 ...
	 *                 entry to be read.
	 * @throws IOException if there is a problem reading the entry from
	 *                     the stream.
	 */
