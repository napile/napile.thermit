...
public abstract class AbstractCvsTask extends Task
{
	 ...
	 * otherwise the output will go to thermit's logging system
	 *
	 ...
	 * otherwise the stderr output will go to thermit's logging system
	 *
	...
	{
		setCompressionLevel(usecomp ? AbstractCvsTask.DEFAULT_COMPRESSION_LEVEL : 0);
	}
