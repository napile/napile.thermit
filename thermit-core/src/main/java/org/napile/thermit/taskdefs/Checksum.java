...
import org.napile.thermit.types.resources.selectors.Type;
				...
				else if(destination instanceof java.io.File)
				{
					...
					else
					{
						...
						fos.write(format.format(new Object[]{
								checksum,
								src.getName(),
								FileUtils.getRelativePath(dest.getParentFile(), src),
								FileUtils.getRelativePath(getProject().getBaseDir(), src),
								src.getAbsolutePath()
						}).getBytes());
