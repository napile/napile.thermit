...
public abstract class Definer extends DefBase
{
	...
	public void execute() throws BuildException
	{
		...
		if(!definerSet)
		{
			...
			//automatically.
			//NB: URIs in the thermit core package will be "" at this point.
			if(getURI() == null)
			{
		...
		else
		{
			...
			while(urls.hasMoreElements())
			{
				...
				else
				{
					...
					{
						log("Warning: Recursive loading of " + url + " ignored" + " at " + getLocation() + " originally loaded at " + RESOURCE_STACK.get().get(url), Project.MSG_WARN);
					}
					else
					{
						try
	 ...
	 * thermit name/classname pairs from.
	 *
	 * @param file the file
	 */
