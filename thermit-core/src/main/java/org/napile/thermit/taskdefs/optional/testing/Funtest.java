...
package org.napile.thermit.taskdefs.optional.testing;

import org.napile.thermit.Task;
import org.napile.thermit.Project;
import org.napile.thermit.BuildException;
import org.napile.thermit.TaskAdapter;
import org.napile.thermit.util.WorkerAnt;
import org.napile.thermit.taskdefs.condition.Condition;
import org.napile.thermit.taskdefs.condition.ConditionBase;
import org.napile.thermit.taskdefs.Parallel;
import org.napile.thermit.taskdefs.Sequential;
import org.napile.thermit.taskdefs.WaitFor;
...
public class Funtest extends Task
{
	...
	protected void processExceptions()
	{
		...
		if(failureProperty != null && getProject().getProperty(failureProperty) != null)
		{
			//we've failed
			log(failureMessage);
