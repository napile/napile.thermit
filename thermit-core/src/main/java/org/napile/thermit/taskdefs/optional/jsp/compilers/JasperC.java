...
package org.napile.thermit.taskdefs.optional.jsp.compilers;
...
import org.napile.thermit.taskdefs.optional.jsp.JspC;
import org.napile.thermit.taskdefs.optional.jsp.JspMangler;
...
public class JasperC extends DefaultJspCompilerAdapter
{
	...
	public boolean execute() throws BuildException
	{
		...
		try
		{
			...
			java.setClassname("org.napile.jasper.JspC");
	...
	private boolean isTomcat5x()
	{
		...
		try
		{
			...
			l.loadClass("org.napile.jasper.tagplugins.jstl.If");
			return true;
		}
