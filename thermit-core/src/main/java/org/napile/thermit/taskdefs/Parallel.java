 ...
 * <p>
 * New behavior allows for the thermit script to specify a maximum number of
...
public class Parallel extends Task implements TaskContainer
{
	...
	private void updateThreadCounts()
	{
		...
		{
			numThreads = Runtime.getRuntime().availableProcessors() * numThreadsPerProcessor;
		}
	}
	...
	private void spinThreads() throws BuildException
	{
		...
		synchronized(semaphore)
		{
			...
			{
				// https://issues.napile.org/bugzilla/show_bug.cgi?id=49527
				killAll(running);
			}
		}
