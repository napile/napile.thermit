 ...
 * the thermit task in question could compute them but does not (for
 ...
 * </li><li>
 * Record the fact that java files must be recompiled if the thermit build file changes
 * </li></ul>
 *
...
public class DependSet extends MatchingTask
{
	...
	private static final ResourceComparator DATE = new org.napile.thermit.types.resources.comparators.Date();
	...
	{
		org.napile.thermit.types.resources.selectors.Date datesel = new org.napile.thermit.types.resources.selectors.Date();
	...
	{
		log(r.toLongString() + " is " + what + ", modified at " + new Date(r.getLastModified()), verbose ? Project.MSG_INFO : Project.MSG_VERBOSE);
	}
