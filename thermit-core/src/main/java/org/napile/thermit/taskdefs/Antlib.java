 ...
 * occur in an thermit build file. It is the root element
 * an antlib xml file.
 *
 * @since Ant 1.6
 */
public class Antlib extends Task implements TaskContainer
{
	...
	public void execute()
	{
		...
		for(Iterator<Object> i = tasks.iterator(); i.hasNext(); )
		{
			...
			{
				throw new BuildException("Invalid task in antlib " + ue.getTag() + " " + configuredObject.getClass() + " does not " + "extend org.napile.thermit.taskdefs.AntlibDefinition");
			}
