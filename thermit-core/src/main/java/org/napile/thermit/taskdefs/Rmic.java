...
import org.napile.thermit.taskdefs.rmic.RmicAdapter;
import org.napile.thermit.taskdefs.rmic.RmicAdapterFactory;
...
public class Rmic extends MatchingTask
{
	...
	/**
	 * Sets whether or not to include thermit's own classpath in this task's
	 * classpath.
	 * Optional; default is <code>true</code>.
	 *
	 * @param include if true include thermit's classpath
	 */
	...
	/**
	 * Gets whether or not the thermit classpath is to be included in the
	 * task's classpath.
	 *
	 * @return true if thermit's classpath is to be included
	 */
	...
	public boolean isValidRmiRemote(String classname)
	{
		...
		{
			log(ERROR_UNABLE_TO_VERIFY_CLASS + classname + ERROR_LOADING_CAUSED_EXCEPTION + t.getMessage(), Project.MSG_WARN);
		}
