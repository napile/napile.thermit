...
public class Exit extends Task
{
	...
	public void execute() throws BuildException
	{
		...
		if(fail)
		{
			...
			{
				if(ifCondition != null && !"".equals(ifCondition) && testIfCondition())
				{
					text = "if=" + ifCondition;
				}
				if(unlessCondition != null && !"".equals(unlessCondition) && testUnlessCondition())
				{
					if(text == null)
					{
						text = "";
	...
	{
		return PropertyHelper.getPropertyHelper(getProject()).testIfCondition(ifCondition);
	}
