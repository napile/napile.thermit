...
import org.napile.thermit.taskdefs.Ant.TargetElement;


/**
 * Calls a given target for all defined sub-builds. This is an extension
 * of thermit for bulk project execution.
 * <p>
...
public class SubAnt extends Task
{
	...
	/**
	 * Process input into the thermit task
	 *
...
*/
	 ...
	 *
	 * @param afile (path of the generic thermit file, absolute or relative to
	...
	/**
	 * Corresponds to <code>&lt;thermit&gt;</code>'s
	...
	/**
	 * Creates the &lt;thermit&gt; task configured to run a specific target.
	 *
	 * @param directory : if not null the directory where the build should run
	 * @return the thermit task, configured with the explicit properties and
