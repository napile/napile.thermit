...
public class CallTarget extends Task
{
	...
	/**
	 * Initialize this task by creating new instance of the thermit task and
	...
	/**
	 * Delegate the work to the thermit task instance, after setting it up.
	 *
	...
	public void execute() throws BuildException
	{
		...
		callee.setAntfile(getProject().getProperty("thermit.file"));
