...
import org.napile.thermit.types.selectors.DifferentSelector;
...
import org.napile.thermit.types.selectors.SelectorContainer;
import org.napile.thermit.types.selectors.SizeSelector;
import org.napile.thermit.types.selectors.TypeSelector;
...
public abstract class MatchingTask extends Task implements SelectorContainer
{
	...
	{
		log("The items attribute is deprecated. " + "Please use the includes attribute.", Project.MSG_WARN);
	...
	{
		log("The ignore attribute is deprecated." + "Please use the excludes attribute.", Project.MSG_WARN);
