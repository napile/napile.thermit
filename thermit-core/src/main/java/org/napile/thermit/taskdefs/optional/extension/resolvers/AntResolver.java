 ...
 *
 */
package org.napile.thermit.taskdefs.optional.extension.resolvers;
...
import org.napile.thermit.taskdefs.Ant;
import org.napile.thermit.taskdefs.optional.extension.Extension;
import org.napile.thermit.taskdefs.optional.extension.ExtensionResolver;
...
public class AntResolver implements ExtensionResolver
{
	...
	/**
	 * Sets the thermit file
	 *
	 * @param antfile the thermit file to set
	 */
	...
	public File resolve(final Extension extension, final Project project) throws BuildException
	{
		...
		try
		{
			final File dir = antfile.getParentFile().getCanonicalFile();
			ant.setDir(dir);
		}
