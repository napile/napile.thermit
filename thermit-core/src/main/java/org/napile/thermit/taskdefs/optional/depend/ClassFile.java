...
import org.napile.thermit.taskdefs.optional.depend.constantpool.ClassCPInfo;
import org.napile.thermit.taskdefs.optional.depend.constantpool.ConstantPool;
import org.napile.thermit.taskdefs.optional.depend.constantpool.ConstantPoolEntry;
...
public class ClassFile
{
	 ...
	 * @throws IOException      if there is a problem reading from the given
	 *                          stream.
	...
	public void read(InputStream stream) throws IOException, ClassFormatError
	{
		...
		// right we have a good looking class file.		/* int minorVersion = */
