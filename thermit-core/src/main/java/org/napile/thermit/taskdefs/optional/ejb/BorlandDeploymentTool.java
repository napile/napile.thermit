...
package org.napile.thermit.taskdefs.optional.ejb;
...
public class BorlandDeploymentTool extends GenericDeploymentTool implements ExecuteStreamHandler
{
	...
	{
		org.napile.thermit.taskdefs.Java javaTask = null;
	...
	{
		getTask().getProject().addTaskDefinition("internal_bas_generateclient", org.napile.thermit.taskdefs.optional.ejb.BorlandGenerateClient.class);

		org.napile.thermit.taskdefs.optional.ejb.BorlandGenerateClient gentask = null;
	...
	// implementation of org.napile.thermit.taskdefs.ExecuteStreamHandler interface
