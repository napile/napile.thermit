...
public class Execute
{
	...
	public static synchronized Map<String, String> getEnvironmentVariables()
	{
		...
		if(JavaEnvUtils.isAtLeastJavaVersion(JavaEnvUtils.JAVA_1_5) && !Os.isFamily("openvms"))
		{
			try
			{
				@SuppressWarnings("unchecked")
				final Map<String, String> cast = (Map<String, String>) System.class.getMethod("getenv", new Class[0]).invoke(null, new Object[0]);
	...
	{
		return (env == null || newEnvironment) ? env : patchEnvironment();
	}
	...
	{
		workingDirectory = (wd == null || wd.getAbsolutePath().equals(antWorkingDirectory)) ? null : wd;
	}
	...
	{
		return workingDirectory == null ? new File(antWorkingDirectory) : workingDirectory;
	}
	...
	public void spawn() throws IOException
	{
		...
		if(Os.isFamily("windows"))
		{
			...
			{
				project.log("interruption in the sleep after having spawned a" + " process", Project.MSG_VERBOSE);
			}
		}
