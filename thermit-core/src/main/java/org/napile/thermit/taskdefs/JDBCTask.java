 ...
 * <p/>
 * import org.napile.thermit.BuildException;
 * import org.napile.thermit.taskdefs.JDBCTask;
 * <p/>
...
public abstract class JDBCTask extends Task
{
	...
	/**
	 * whether the task fails when thermit fails to connect to the database.
	 *
	 * @since Ant 1.8.0
	 */
	...
	protected Connection getConnection() throws BuildException
	{
		...
		try
		{
			...
			for(Iterator<Property> props = connectionProperties.iterator(); props.hasNext(); )
			{
	 ...
	 * Uses the thermit class loader and the optionally the provided classpath.
	 *
	 * @return Driver
