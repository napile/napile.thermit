...
public class ChangeLogWriter
{
	...
	public void printChangeLog(final PrintWriter output, final CVSEntry[] entries)
	{
		...
		{
			throw new org.napile.thermit.BuildException(e);
		}
	}
	...
	private void printEntry(Document doc, final PrintWriter output, final CVSEntry entry) throws IOException
	{
		...
		DOMUtils.appendTextElement(ent, "date", OUTPUT_DATE.format(entry.getDate()));
		DOMUtils.appendTextElement(ent, "time", OUTPUT_TIME.format(entry.getDate()));
