 ...
 * /org/napile/tools/thermit/listener/defaults.properties
 * file.
 ...
 * thermit.logger.defaults, with value set to the path of
...
public class AnsiColorLogger extends DefaultLogger
{
	 ...
	 * special thermit property thermit.logger.defaults
	 */
	private void setColors()
	{
		String userColorFile = System.getProperty("thermit.logger.defaults");
		String systemColorFile = "/org/napile/thermit/listener/defaults.properties";
