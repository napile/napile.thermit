 ...
 *
 */
package org.napile.thermit.listener;
...
public class BigProjectLogger extends SimpleBigProjectLogger implements SubBuildListener
{
	...
	public void subBuildStarted(BuildEvent event)
	{
		...
		printMessage(StringUtils.LINE_SEP + getHeader() + StringUtils.LINE_SEP + "Entering project " + name + StringUtils.LINE_SEP + path + StringUtils.LINE_SEP + getFooter(), out, event.getPriority());
	}
	...
	public void subBuildFinished(BuildEvent event)
	{
		...
		printMessage(StringUtils.LINE_SEP + getHeader() + StringUtils.LINE_SEP + "Exiting " + failed + "project " + name + StringUtils.LINE_SEP + getFooter(), out, event.getPriority());
	}
