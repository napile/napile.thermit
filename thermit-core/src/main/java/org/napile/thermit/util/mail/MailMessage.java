...
package org.napile.thermit.util.mail;
...
public class MailMessage
{
	 ...
	 * @throws IOException if there's any problem reported by the mail server
	 * @see org.napile.thermit.taskdefs.email.Message
	 */
	public PrintStream getPrintStream() throws IOException
	{
		...
		setToHeader();
		setCcHeader();
		setHeader("X-Mailer", "org.napile.thermit.util.mail.MailMessage (thermit.napile.org)");
		sendData();
		flushHeaders();
		return out;
	}
