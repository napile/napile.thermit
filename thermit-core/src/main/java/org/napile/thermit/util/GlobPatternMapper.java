...
public class GlobPatternMapper implements FileNameMapper
{
	...
	public String[] mapFileName(String sourceFileName)
	{
		...
		if(fromPrefix == null || (sourceFileName.length() < (prefixLength + postfixLength)) || (!fromContainsStar && !modName.equals(modifyName(fromPrefix))) || (fromContainsStar && (!modName.startsWith(modifyName(fromPrefix)) || !modName.endsWith(modifyName(fromPostfix)))))
		{
			return null;
		}
		return new String[]{
				toPrefix + (toContainsStar ? extractVariablePart(sourceFileName) + toPostfix : "")
		};
	}
