...
import org.napile.thermit.PathTokenizer;
import org.napile.thermit.Project;
import org.napile.thermit.launch.Locator;
...
public class FileUtils
{
	 ...
	 * fromUri is called for each element when parseing thermit build
	 ...
	 * @since Ant 1.8
	 */
	public void copyFile(File sourceFile, File destFile, FilterSetCollection filters, Vector filterChains, boolean overwrite, boolean preserveLastModified, boolean append, String inputEncoding, String outputEncoding, Project project) throws IOException
	{
		copyFile(sourceFile, destFile, filters, filterChains, overwrite, preserveLastModified, append, inputEncoding, outputEncoding, project, /* force: */ false);
	}
	 ...
	 * @param parentDir Directory to create the temporary file in; java.io.tmpdir used
	 *                  if not specified.
	 * @return a File reference to the new, nonexistent temporary file.
	 * @deprecated since thermit 1.7.1 use createTempFile(String, String, File,
