...
class FallbackZipEncoding implements ZipEncoding
{
	...
	/**
	 * @see org.napile.thermit.util.zip.ZipEncoding#canEncode(java.lang.String)
	 */
	...
	/**
	 * @see org.napile.thermit.util.zip.ZipEncoding#encode(java.lang.String)
	 */
	public ByteBuffer encode(String name) throws IOException
	{
		if(this.charset == null)
		{ // i.e. use default charset, see no-args constructor
	...
	/**
	 * @see org.napile.thermit.util.zip.ZipEncoding#decode(byte[])
	 */
