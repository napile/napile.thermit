...
public class ScriptRunnerCreator
{
	...
	private static final String OATAU = "org.napile.thermit.util";
	private static final String UTIL_OPT = OATAU + ".optional";

	private static final String BSF = "bsf";
	private static final String BSF_PACK = "org.napile.bsf";
	...
	public synchronized ScriptRunnerBase createRunner(String manager, String language, ClassLoader classLoader)
	{
		...
		{
			throw new BuildException("Unable to load the script engine manager " + "(" + JAVAX_MANAGER + ")");
		}
		if(BSF.equals(manager))
		{
			throw new BuildException("Unable to load the BSF script engine manager " + "(" + BSF_MANAGER + ")");
		}
		throw new BuildException("Unable to load a script engine manager " + "(" + BSF_MANAGER + " or " + JAVAX_MANAGER + ")");
	}
	 ...
	 * @param runnerClass  the name of thermit's script runner for this manager.
