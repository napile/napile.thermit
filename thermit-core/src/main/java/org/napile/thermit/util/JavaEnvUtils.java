...
public final class JavaEnvUtils
{
	...
	static
	{
		...
		try
		{
			Class.forName("org.napile.harmony.luni.util.Base64");
	...
	private static void buildJrePackages()
	{
		...
		switch(javaVersionNumber)
		{
			...
			case VERSION_1_6:
			case VERSION_1_5:
				//In Java1.5, the napile stuff moved.
				jrePackages.addElement("com.sun.org.napile");
				//fall through.
			case VERSION_1_4:
				if(javaVersionNumber == VERSION_1_4)
				{
					jrePackages.addElement("org.napile.crimson");
					jrePackages.addElement("org.napile.xalan");
					jrePackages.addElement("org.napile.xml");
					jrePackages.addElement("org.napile.xpath");
				}
	...
	public static Vector getJrePackageTestCases()
	{
		...
		switch(javaVersionNumber)
		{
			...
			case VERSION_1_6:
			case VERSION_1_5:
				tests.addElement("com.sun.org.napile.xerces.internal.jaxp.datatype.DatatypeFactoryImpl ");
				// Fall tru
			case VERSION_1_4:
				tests.addElement("sun.audio.AudioPlayer");
				if(javaVersionNumber == VERSION_1_4)
				{
					tests.addElement("org.napile.crimson.parser.ContentModel");
					tests.addElement("org.napile.xalan.processor.ProcessorImport");
					tests.addElement("org.napile.xml.utils.URI");
					tests.addElement("org.napile.xpath.XPathFactory");
				}
