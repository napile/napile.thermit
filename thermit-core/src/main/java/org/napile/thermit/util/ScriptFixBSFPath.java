...
{
	private static final String UTIL_OPTIONAL_PACKAGE = "org.napile.thermit.util.optional";

	private static final String BSF_PACKAGE = "org.napile.bsf";
	private static final String BSF_MANAGER = BSF_PACKAGE + ".BSFManager";
	private static final String BSF_SCRIPT_RUNNER = UTIL_OPTIONAL_PACKAGE + ".ScriptRunner";
	 ...
	 */
	private static final String[] BSF_LANGUAGES = new String[]{
			"js",
			...
			"org.python.core.Py",
			"xslt",
			"org.napile.xpath.objects.XObject"
	};
