...
/**
 * Offers some helper methods on the Path structure in thermit.
 * <p/>
...
public class ClasspathUtils
{
	 ...
	 * 'thermit.reuse.loader' this will try to reuse the previously
	 ...
	 * <p/>
	 * <p>This method completely ignores the thermit.reuse.loader magic
	 ...
	 * Classes and instantiate them often expose the following thermit syntax
	 * sugar: </p>
	 * <p/>
	...
	public static class Delegate
	{
		...
		{
			return getClassLoaderForPath(getContextProject(), classpath, getClassLoadId(), reverseLoader, loaderId != null || isMagicPropertySet(getContextProject()));
		}
