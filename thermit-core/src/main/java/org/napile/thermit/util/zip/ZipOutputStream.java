...
import static org.napile.thermit.util.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static org.napile.thermit.util.zip.ZipConstants.DWORD;
import static org.napile.thermit.util.zip.ZipConstants.INITIAL_VERSION;
...
import static org.napile.thermit.util.zip.ZipConstants.ZIP64_MIN_VERSION;
...
public class ZipOutputStream extends FilterOutputStream
{
	 ...
	 * https://issues.napile.org/bugzilla/show_bug.cgi?id=45396
	 *
	...
	protected void writeZip64CentralDirectory() throws IOException
	{
		...
		writeOut(ZipEightByteInteger.getBytes(SHORT   /* version made by */ + SHORT /* version needed to extract */ + WORD  /* disk number */ + WORD  /* disk with central directory */ + DWORD /* number of entries in CD on this disk */ + DWORD /* total number of entries */ + DWORD /* size of CD */ + DWORD /* offset of CD */));
