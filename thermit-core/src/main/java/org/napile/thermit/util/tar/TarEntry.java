...
package org.napile.thermit.util.tar;
...
import org.napile.thermit.util.zip.ZipEncoding;
...
public class TarEntry implements TarConstants
{
	 ...
	 */
	private static boolean isEqual(final byte[] buffer1, final int offset1, final int length1, final byte[] buffer2, final int offset2, final int length2, boolean ignoreTrailingNulls)
	{
