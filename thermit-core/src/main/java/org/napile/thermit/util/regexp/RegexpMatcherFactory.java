 ...
 *
 */
package org.napile.thermit.util.regexp;
 ...
 * property <code>thermit.regexp.regexpimpl</code> and the classes available.
 * <p/>
 * <p>
...
public class RegexpMatcherFactory
{
	 ...
	 * Create a new regular expression instance.
	 *
	 * @param p Project whose thermit.regexp.regexpimpl property will be used.
	 * @return the matcher
	 * @throws BuildException on error
	 */
